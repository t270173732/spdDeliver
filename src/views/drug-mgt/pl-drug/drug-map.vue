                        ...
                        <div class="drugContent">
                            <div class="innerDiv" style="width:500px">
                                ...
                                <a-row class="marginCol">
                                    ...
                                    <a-col span="16">
                                        <a-input size="small" :read-only="true" v-model="PLDrug.drugId"></a-input>
                                    </a-col>
                                </a-row>
                                <a-row class="marginCol">
                                    <a-col span="7">生产厂商:</a-col>
                                    <a-col span="16">
                                        <a-input size="small" v-model="PLDrug.factoryId"></a-input>
                                    </a-col>
                                </a-row>
                                <a-row class="marginCol">
                                    <a-col span="7">包装规格:</a-col>
                                    <a-col span="16">
                                        <a-input size="small" v-model="PLDrug.packSpec"></a-input>
                                    </a-col>
                                </a-row>
                                <a-row class="marginCol">
                                    <a-col span="7">包装单位:</a-col>
                                    <a-col span="16">
                                        <a-input size="small" v-model="PLDrug.packUnit"></a-input>
                                    </a-col>
                                </a-row>
                                <a-row class="marginCol">
                                    <a-col span="7">大包装单位:</a-col>
                                    <a-col span="16">
                                        <a-input size="small" v-model="PLDrug.maxUnit"></a-input>
                                    </a-col>
                                </a-row>
                                <a-row class="marginCol">
                                    <a-col span="7">大包装数:</a-col>
                                    <a-col span="16">
                                        <a-input size="small" type="number" v-model="PLDrug.maxPackRatio"></a-input>
                                    </a-col>
                                </a-row>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            mapDrug() {
                this.current = 1;
                this.fetchPLDrugData(this.SPDDrug)
            },
            //气泡网格页码变化
            pageChange(page, pageSize) {
                let params = this.SPDDrug;
                params.offset = (page - 1) * pageSize;
                this.fetchPLDrugData(params)
            },
            fetchPLDrugData(value = {}) {
                this.PLDrugData = []
